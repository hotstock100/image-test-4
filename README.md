...
OrionLib:MakeNotification({
	...
	Image = "https://tr.rbxcdn.com/180DAY-ab47934ecc2e69277215a6f568b8754f/150/150/Image/Webp/noFilter",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Welcome🫡",
    Icon = "https://tr.rbxcdn.com/180DAY-ab47934ecc2e69277215a6f568b8754f/150/150/Image/Webp/noFilter",
    PremiumOnly = false
})

local M = Window:MakeTab({
    Name = " farm General🪐",
    Icon = "banner_classe_alta.psd (1).png",
    PremiumOnly = false
})
...
local S = Window:MakeTab({
    Name = "Stats❗",
    Icon = "C:\Users\ARLETE\Downloads\banner_classe_alta.psd (1).png",
    PremiumOnly = false
})
